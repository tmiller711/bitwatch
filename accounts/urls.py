...
from .views import (GetUser, GetUserByID, Login, Register, activate, EditProfile, Subscribe, Unsubscribe, GetSubscriptions, History, GetUserPlaylists, CreatePlaylist, UpdatePlaylist,
                    PlaylistByID)
